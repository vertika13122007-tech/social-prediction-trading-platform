...
const INITIAL_TRANSACTIONS = [
  {
    ...
    borderGlow: "hover:border-l-emerald-400",
    date: "Today, 9:00 AM",
    status: "completed",
  },
  {
    ...
    amount: "+2,450",
    amountColor: "text-emerald-600 dark:text-emerald-400",
    borderGlow: "hover:border-l-blue-400",
  ...
  },
  {
    ...
    borderGlow: "hover:border-l-orange-400",
  ...
  },
  {
    ...
    amount: "+5,000",
    amountColor: "text-emerald-600 dark:text-emerald-400",
    borderGlow: "hover:border-l-purple-400",
  ...
  },
  {
    ...
    amount: "-2,000",
    amountColor: "text-red-500 dark:text-red-400",
    borderGlow: "hover:border-l-red-400",
